...
function enqueueNewTest() {
  ...
  ge.element.one("ganttalendar.redrawCompleted", function () {
  ...
  //se nel test ci sono i task si resetta il ganttalendar
  if (test.tasks) {
    //si resetta tutto
    ge.reset();
    ...
    ge.element.trigger("ganttalendar.redrawCompleted");
  }
...
$(function () {
  ...
  $("#workSpace").one("ganttalendar.redrawCompleted", function () {
